...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	contentModerationSessionStore := repository.NewContentModerationSessionStore(redisClient)
	...
	contentModerationService.SetSessionStore(contentModerationSessionStore)
