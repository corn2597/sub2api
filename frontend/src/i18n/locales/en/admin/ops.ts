export default {
    ops: {
      ...
      errorDetail: {
        ...
        requestPayloads: 'Complete HTTP2WS Error Requests',
        requestPayloadWarning: 'May contain sensitive user data; use only for short-lived diagnostics',
        downloadRequestPayload: 'Download original',
        payloadDownloadFailed: 'Failed to download complete request',
        payloadAttempt: 'Attempt',
        payloadAccount: 'Account',
        payloadWriteResult: 'Write result',
        payloadWriteSucceeded: 'Written',
        payloadWriteFailed: 'Write failed',
        payloadReused: 'Reused connection',
        payloadNewConnection: 'New connection',
        payloads: {
