export default {
    ops: {
      ...
      errorDetail: {
        ...
        requestPayloads: '完整 HTTP2WS 错误请求',
        requestPayloadWarning: '内容可能包含用户敏感数据，仅用于短期排障',
        downloadRequestPayload: '下载原文',
        payloadDownloadFailed: '下载完整请求失败',
        payloadAttempt: '尝试',
        payloadAccount: '账号',
        payloadWriteResult: '写入结果',
        payloadWriteSucceeded: '已写出',
        payloadWriteFailed: '写入失败',
        payloadReused: '复用连接',
        payloadNewConnection: '新连接',
        payloads: {
          client: '客户端响应',
